...
#seqLength1 = (1050,1011,1056,1158,1059,1218,1056,966,861,945,1101,1221,1071,2802,1653,1227,2520,1062,1011,1146,1164,1227,2958,1197,1047,1881,891,882,1743)
...
#seqLength3 = (855,1146,1122,1137,1221,1058,1215,888,598,1074,1068,1050,1752,1521,1500,1065,1041,1089,1271,1209,1218,1068,73,1059,1068,1545,1056,1065,1275,918,1179,1059,1575,1023,1021,522,597,600,594,291,268,666,663,630,624,591,540,552)

SeqLength=((1050,1011,1056,1158,1059,1218,1056,966,861,945,1101,1221,1071,2802,1653,1227,2520,1062,1011,1146,1164,1227,2958,1197,1047,1881,891,882,1743), (855,1146,1122,1137,1221,1058,1215,888,598,1074,1068,1050,1752,1521,1500,1065,1041,1089,1271,1209,1218,1068,73,1059,1068,1545,1056,1065,1275,918,1179,1059,1575,1023,1021), (855,1146,1122,1137,1221,1058,1215,888,598,1074,1068,1050,1752,1521,1500,1065,1041,1089,1271,1209,1218,1068,73,1059,1068,1545,1056,1065,1275,918,1179,1059,1575,1023,1021,522,597,600,594,291,268,666,663,630,624,591,540,552))


Nbgenes=list()
for i in range(len(SeqLength)):
	Nbgenes.append(len(SeqLength[i]))



outputname=','.join(str(e) for e in Nbgenes)
...
for seqLength in SeqLength:
	...
	np.savetxt("out_simu_stop_DiffSeqLength_{}_generations_{}_repeats_{}_mu_{}_ind_{}_migra_{}_migrants_{}_mig_{}_h_{}_s_{}_SeqList_{}_SeqLength.csv".format(param["nbGeneration"], param["nbRepeats"], param["txMut"], param["popSize"],param["probMigra"], param["indMigra"],param["txmigra"], param["h"], param["fitness"], outputname, len(seqLength)), countMutaMatrix, delimiter=",")
...
for Y in Nbgenes:
	labels_list.append(str(Y))

labels_list=["Number of genes=" + x for x in labels_list]


with PdfPages("graphe_simu_stop_2SeqLength_{}_generations_{}_repeats_{}_mu_{}_ind_{}_migra_{}_migrants_{}_mig_{}_h_{}_s_{}_SeqList.pdf".format(param["nbGeneration"], param["nbRepeats"], param["txMut"], param["popSize"],param["probMigra"], param["indMigra"],param["txmigra"], param["h"], param["fitness"], outputname)) as pdf:

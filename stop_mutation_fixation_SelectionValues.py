...
s=raw_input("Liste des valeurs selectives (valeur selective des pseudogenes), separees par des espaces: ")
...
d=raw_input("Liste des valeurs de dominance voulues, separees par des espaces: ")
...
with PdfPages("graphe_simu_stop_SelectionDiff_{}_generations_{}_repeats_{}_mu_{}_ind_{}_migra_{}_migrants_{}_mig.pdf".format(param["nbGeneration"], param["nbRepeats"], param["txMut"], param["popSize"],param["probMigra"], param["indMigra"],param["txmigra"])) as pdf:
